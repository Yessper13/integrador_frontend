...
export default function NavBar() {
  ...
  // Abrir automáticamente el módulo correspondiente según la ruta actual
  useEffect(() => {
    ...
    <>
      ...
      >
        ...
        <li className={`nav-item ${open.collapseIngreso ? "active" : ""}`}>
          ...
          <div
            className={`${
              open.collapseIngreso ? "collapse show" : "collapse"
            } collapse-transition`}
            id="collapseIngreso"
          >
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <Link
                className={`collapse-item ${isActive("/listado-estudiantes")}`}
                to="/listado-estudiantes"
              >
                Ver Estudiantes
              </Link>
              <Link
                className={`collapse-item ${isActive("/crear-estudiante")}`}
                to="/crear-estudiante"
              >
                Crear Estudiante
              </Link>
        ...
        <li className={`nav-item ${open.collapseHistorial ? "active" : ""}`}>
          ...
          <div
            className={`${
              open.collapseHistorial ? "collapse show" : "collapse"
            } collapse-transition`}
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              <h6 className="collapse-header">Acciones:</h6>
              <Link
                className={`collapse-item ${isActive("/listado-historial")}`}
                to="/listado-historial"
              >
                Ver Historial
              </Link>
              <Link
                className={`collapse-item ${isActive("/crear-historial")}`}
                to="/crear-historial"
              >
                Crear Registro
              </Link>
        ...
        <li className={`nav-item ${open.collapseFamiliar ? "active" : ""}`}>
          ...
          <div
            className={`${
              open.collapseFamiliar ? "collapse show" : "collapse"
            } collapse-transition`}
            id="collapseFamiliar"
          >
            <div className="bg-white py-2 collapse-inner rounded">
              <h6 className="collapse-header">Acciones:</h6>
              <Link
                className={`collapse-item ${isActive("/listado-familiares")}`}
                to="/listado-familiares"
              >
                Ver Familiares
              </Link>
              <Link
                className={`collapse-item ${isActive("/crear-familiar")}`}
                to="/crear-familiar"
              >
                Crear Familiar
              </Link>
        ...
        <li className={`nav-item ${open.collapseNotas ? "active" : ""}`}>
          ...
          <div
            className={`${
              open.collapseNotas ? "collapse show" : "collapse"
            } collapse-transition`}
            id="collapseNotas"
          >
            <div className="bg-white py-2 collapse-inner rounded">
              <h6 className="collapse-header">Acciones:</h6>
              <Link
                className={`collapse-item ${isActive("/listado-notas")}`}
                to="/listado-notas"
              >
                Ver Notas
              </Link>
              <Link
                className={`collapse-item ${isActive("/crear-nota")}`}
                to="/crear-nota"
              >
                Registrar Nota
              </Link>
        ...
        <li className={`nav-item ${open.collapseAsistencias ? "active" : ""}`}>
          ...
          <div
            className={`${
              open.collapseAsistencias ? "collapse show" : "collapse"
            } collapse-transition`}
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              <h6 className="collapse-header">Acciones:</h6>
              <Link
                className={`collapse-item ${isActive("/listado-asistencias")}`}
                to="/listado-asistencias"
              >
                Ver Asistencias
              </Link>
              <Link
                className={`collapse-item ${isActive("/crear-asistencia")}`}
                to="/crear-asistencia"
              >
        ...
        <li className={`nav-item ${open.collapseBienestar ? "active" : ""}`}>
          ...
          <div
            className={`${
              open.collapseBienestar ? "collapse show" : "collapse"
            } collapse-transition`}
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              <h6 className="collapse-header">Acciones:</h6>
              <Link
                className={`collapse-item ${isActive("/listado-bienestar")}`}
                to="/listado-bienestar"
              >
                Ver Registros
              </Link>
              <Link
                className={`collapse-item ${isActive("/crear-bienestar")}`}
                to="/crear-bienestar"
              >
                Crear Registro
              </Link>
